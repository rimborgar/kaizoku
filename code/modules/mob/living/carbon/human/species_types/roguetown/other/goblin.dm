...
/datum/species/goblin
	...
	limbs_icon_f = 'icons/roguetown/mob/bodies/f/fg.dmi'
	...
	specstats = list("strength" = 0, "perception" = -1, "intelligence" = -2, "constitution" = 1, "endurance" = 1, "speed" = 2, "fortune" = 1)
	specstats_f = list("strength" = -1, "perception" = 1, "intelligence" = -1, "constitution" = 0, "endurance" = 0, "speed" = 3, "fortune" = 0)
